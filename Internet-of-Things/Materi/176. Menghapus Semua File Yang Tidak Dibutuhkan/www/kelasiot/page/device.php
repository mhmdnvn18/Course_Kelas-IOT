...
if(isset($_POST['edit_data'])){
  ...
  $active = $_POST['active']; //variabel active = post active

  //variabel sql_edit + = + function update + nama tabel + function set + nama kolom + = + variabel + function where + nama kolom + = + variabel old_id
  $sql_edit = "UPDATE devices SET serial_number = '$serial_number', mcu_type = '$controller', location = '$location', active = '$active' WHERE serial_number = '$old_id'"; //membuat query sql untuk mengupdate data ke database 

} else if(isset($_POST['serial_number'])){ //jika serial_number ada maka
    //variabel + = + function post + id 'name' pada form
    $serial_number = $_POST['serial_number']; //variabel serial_number = post serial_number
    $controller = $_POST['controller']; //variabel controller = post controller  
    $location = $_POST['location']; //variabel location = post location
            ...
            <?php if(!isset($_GET['edit'])){ ?> <!--jika tidak ada maka-->
              ...
              <div class="card card-primary">
                  <div class="card-header">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="?page=<?php echo $page ?>">  <!-- method post untuk mengirimkan data ke server -->
                      <div class="card-body">
                  ...
                  <div class="card-header">
                    ...
                    <form method="post" action="?page=<?php echo $page ?>">  <!-- method post untuk mengirimkan data ke server -->
                      <div class="card-body">
                        <div class="form-group">
                          <label>Serial Number</label>
                          <!-- input type hidden + name edit_data + value + variabel data['serial_number'] -->
                          <input type="hidden" name="edit_data" value="<?php echo $data['serial_number'] ?>"> <!--menyembunyikan inputan serial_number-->
