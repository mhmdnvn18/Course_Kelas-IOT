<?php
  ...
  echo "DikirimDikirimDikirimDikirimDikirimDikirimDikirimDikirimDikirimDikirimDikirimDikirim";
  }
              ...
              <form method="post" action="?page=device">  <!-- method post untuk mengirimkan data ke server -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="controller" placeholder="Nama Tempat/Alamat" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
