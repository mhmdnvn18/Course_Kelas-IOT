...
if(isset($_POST['edit_data'])){
  ...
  if($_POST['password'] == ""){
    ...
    $sql_edit = "UPDATE user SET username = '$username', password = '$password', fullname = '$fullname', role = '$role', active = '$active' WHERE username = '$old_id'"; //query untuk mengupdate data user berdasarkan username
  }
