...
## 📋 phpMyAdmin
**phpMyAdmin** adalah alat berbasis web yang digunakan untuk mengelola database MySQL atau MariaDB. Dengan phpMyAdmin, pengguna dapat:
- Membuat, mengedit, dan menghapus database, tabel, dan kolom.
- Menjalankan perintah SQL secara langsung.
- Mengekspor dan mengimpor data dalam berbagai format seperti SQL, CSV, dan lainnya.
- Mengelola pengguna database dan izin akses.

phpMyAdmin sering digunakan karena antarmukanya yang ramah pengguna, sehingga memudahkan pengelolaan database tanpa harus menggunakan command-line secara langsung. Alat ini sangat cocok untuk proyek berbasis web, terutama yang melibatkan integrasi ESP32 dengan database untuk menyimpan dan menampilkan data secara real-time.
